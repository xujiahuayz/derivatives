...
Interest rate swap wherein a fixed rate of interest (the OIS rate) is exchanged for a reference rate of interest calculated from a realized overnight rate (e.g. SONIA, SOFR).
